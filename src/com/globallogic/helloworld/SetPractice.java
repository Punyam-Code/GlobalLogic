...
/*
 * public static void delete(String name,TreeSet<Myemp> e) {
 * 
 * boolean flag = false; int a = 0; for (Myemp ea : e) { if
 * (ea.getNa().equalsIgnoreCase(name)) { flag = true; break; } else { a++; } }
 * if (flag) { e.remove(a); System.out.println("Data deleted successfully!!!");
